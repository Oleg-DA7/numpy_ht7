...
if __name__ == "__main__":
    ...
    такі як домінуючі частоти та їх розподіл у часі. Для звуків собак і птахів це особливо важливо, 
    оскільки собаки мають нижчі частоти та імпульсні характеристики, тоді як щебетання птахів 
    характеризується вищими частотами. 
